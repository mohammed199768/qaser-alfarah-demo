...
import { gallery, collections } from "./gallery";
import type { SiteContent, ServiceItem, GalleryItem, GalleryCollection } from "@/types/site-content";
...
export const getGalleryCollections = (): GalleryCollection[] => [...collections].sort((a, b) => a.order - b.order);
